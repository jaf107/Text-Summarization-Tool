...
class SummaryTool{
        ...
        for(int i=0;i<noOfSentences;i++){
            for(int j=0;j<noOfSentences;j++){
                ...
                if(i<=j){
                    ...
                    intersectionMatrix[i][j] = noOfCommonWords(str1,str2) / ((double)(str1.getNoOfWords() + str2.getNoOfWords()) /2);
                }else{
    ...
    void printSentences(){
        for(Sentence sentence : sentences){
            System.out.println(sentence.getNumber() + " => " + sentence.getValue() + " => "+ sentence.getNoOfWords() + " => " + sentence.getParagraphNumber());
        }
    }
